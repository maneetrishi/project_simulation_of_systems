...
Run control_system.m in the MATLAB editor or command window.
The script generates 5 figures automatically:
...
Performance metrics are printed to the Command Window with ±2% settling-time criterion.
Simulink
Open MATLAB and navigate to the simulink/ folder.
Open control_model.slx.
Click Run to simulate.
Open the Scope block to view the closed-loop output.
Results Summary
Table
Figure	Description
